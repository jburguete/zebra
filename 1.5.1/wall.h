...
typedef struct
{
  double in[MAX_SOLUTES];
  ///< array of solute concentration differences.
  double is[MAX_SPECIES];
  ///< array of species concentration differences.
  double dn[MAX_SOLUTES];
  ///< array of solute concentration advection differences.
  double ds[MAX_SPECIES];
  ///< array of species concentration advection differences.
  double dn2[MAX_SOLUTES];
  ///< array of 2nd order solute concentration advection differences.
          ...
          double vdt)           ///< flow velocity times time step size.
{
  ...
  left = wall->left;
  right = wall->right;
  n1 = left->solute_concentration;
  s1 = left->species_concentration;
  n2 = right->solute_concentration;
